...
#define MSM_HTC_DEBUG_INFO_SIZE		SZ_128K	/* 0xFE822000 */
...
#define MSM_IDLE_SLEEP_DELAY_BASE		(MSM_POWER_COLLAPSE_STATUS_BASE - MSM_IDLE_SLEEP_DELAY_SIZE)
#define MSM_IDLE_SLEEP_DELAY_SIZE		4
